    ...
    def load_data(self):
        ...
        if self.arg.phase == 'train':
            self.data_loader['train'] = torch.utils.data.DataLoader(
                dataset=Feeder(**self.arg.train_feeder_args, random_flip=True, dropout=False, random_resizer=False),
        ...
        for idx, name_test_tta in enumerate(self.lst_name_test_tta):
            ...
            self.data_loader[name_test_tta] = torch.utils.data.DataLoader(
                dataset=Feeder(**self.arg.test_feeder_args, random_flip=False, dropout=False, random_resizer=False, tta=self.arg.tta[idx]),
                #dataset=Feeder(**self.arg.test_feeder_args, random_flip=False, dropout=False, random_resizer=False),
